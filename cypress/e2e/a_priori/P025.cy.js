...
import jsonData from "./data/P025.json";

const pageSection = new PageSection();
const adminMenu = new AdminMenu();
const site = new Site();

describe("Publicación de una página nueva con título vacío.", () => {
  it("Publicación de una página nueva con título vacío.", () => {
    /* 
    -------------
      GIVEN
    -------------
    ...
    */
    ...
    pageSection.pageInList("(Untitled)").click();
    ...
    cy.wait(1000);
    site.pageTitle.contains("(Untitled)");
  });
});
