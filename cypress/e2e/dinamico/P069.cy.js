...
describe("Publicación de un post nueva con título que tiene caracteres especiales", () => {
  it("Publicación de un post nueva con título que tiene caracteres especiales", () => {
    /* 
    -------------
      GIVEN
    -------------
