...
describe("Edición únicamente del cuerpo de un post existente con caracteres especiales", () => {
  it("Edición únicamente del cuerpo de un post existente con caracteres especiales", () => {
    /* 
    -------------
      GIVEN
    -------------
